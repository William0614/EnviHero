    ...
    var body: some View {
        ...
        NavigationView {
            LoadingView(isShowing: .constant(webViewStateModel.loading)) { //loading logic taken from https://stackoverflow.com/a/56496896/9838937
                ...
                WebView(url: URL.init(string: "https://climate.nasa.gov/")!, webViewStateModel: self.webViewStateModel)
            }
...
struct WebsitesView_Previews: PreviewProvider {
